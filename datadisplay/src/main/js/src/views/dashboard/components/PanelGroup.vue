<template>
  <el-row :gutter="40" class="panel-group">
    <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
      <div class="card-panel" @click="handleSetLineChartData('newPositions')">
        <div class="card-panel-icon-wrapper icon-people">
          <svg-icon icon-class="newPosition" class-name="card-panel-icon" />
        </div>
    ...
    <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
      <div class="card-panel" @click="handleSetLineChartData('positions')">
        <div class="card-panel-icon-wrapper icon-message">
          <svg-icon icon-class="positions" class-name="card-panel-icon" />
        </div>
        <div class="card-panel-description">
    ...
    <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
      <div class="card-panel" @click="handleSetLineChartData('name')">
        <div class="card-panel-icon-wrapper icon-money">
          <svg-icon icon-class="user" class-name="card-panel-icon" />
        </div>
        <div class="card-panel-description">
          <div class="card-panel-text">Name</div>
    ...
    <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
      <div class="card-panel" @click="handleSetLineChartData('role')">
        ...
        <div class="card-panel-description">
          <div class="card-panel-text">Role</div>
          <div class="card-panel-num"><span v-for="role in roles" :key="role.id">{{ role.roleName }}</span></div>
        </div>
      </div>
    </el-col>
  </el-row>
